 ...
 * @since 1.0
 */
public class CobarClientInternalRouter implements ICobarRouter<HibernateRoutingFact> {
    ...
    private List<Set<IRoutingRule<HibernateRoutingFact, List<String>>>> ruleSequences          = new ArrayList<Set<IRoutingRule<HibernateRoutingFact, List<String>>>>();
    ...
    public RoutingResult doRoute(HibernateRoutingFact routingFact) throws RoutingException {
        ...
        if (!CollectionUtils.isEmpty(getRuleSequences())) {
            for (Set<IRoutingRule<HibernateRoutingFact, List<String>>> ruleSet : getRuleSequences()) {
    ...
    public void setRuleSequences(List<Set<IRoutingRule<HibernateRoutingFact, List<String>>>> ruleSequences) {
        this.ruleSequences = ruleSequences;
    }

    public List<Set<IRoutingRule<HibernateRoutingFact, List<String>>>> getRuleSequences() {
