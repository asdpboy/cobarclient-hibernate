 ...
 * @since 1.0
 */
public class HibernateMethodNameShardingRule extends AbstractHibernateOrientedRule {

	 private transient final Logger logger = LoggerFactory
            .getLogger(HibernateMethodNameShardingRule.class);

	 public HibernateMethodNameShardingRule(String pattern, String action,
	...
	public boolean isDefinedAt(HibernateRoutingFact routingFact) {
        ...
        boolean matches = StringUtils.equals(routingFact.getMethod(), getTypePattern());
        if (matches) {
            try {
    ...
    public String toString() {
        return "HibernateMethodNameShardingRule [getAction()=" + getAction() + ", getTypePattern()="
                + getTypePattern() + "]";
    }
}
