...
public class InternalRules {
    ...
    public static void main(String[] args) {
        ...
        r1.setClassName("com.alibaba.cobar.client.entity.Follower");
        r1.setShards("partition1");
        rList.add(r1);
        InternalRule r2 = new InternalRule();
        r2.setMethodName("com.alibaba.cobar.client.entity.Follower.save");
        r2.setShards("p1, p2");
        rList.add(r2);
        InternalRule r3 = new InternalRule();
        r3.setMethodName("com.alibaba.cobar.client.entity.Follower.create");
        r3.setShardingExpression("id>10000 and id< 20000");
        r3.setShards("p1, p2");
        rList.add(r3);
        InternalRule r4 = new InternalRule();
        r4.setClassName("com.alibaba.cobar.client.entity.Follower");
        r4.setShardingExpression("id>10000 and id< 20000");
        r4.setShards("p1, p2");
        r4.setTshardingExpression("mod.apply(memberId)==0");
        r4.setTshards("${tab}0");
