 ...
 * @since 1.0
 */
public class RequestDepositoryForSQL {
    private ConcurrentRequestForSQL originalRequest;
    private Connection        connectionToUse;
    private boolean           transactionAware;
    private PreparedStatement ps ;

    public ConcurrentRequestForSQL getOriginalRequest() {
        return originalRequest;
    }

    public void setOriginalRequest(ConcurrentRequestForSQL originalRequest) {
